...
from nuc_morph_analysis.analyses.cell_health import cell_health_functions

# %% load data
df = global_dataset_filtering.load_dataset_with_features()
df_full = filter_data.all_timepoints_full_tracks(df)
df = cell_health_functions.subset_main_dataset(df, df_full)
#%%
...
figdir = "cell_health/figures/lineage/main/"
# %%

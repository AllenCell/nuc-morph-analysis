...
LABEL_TABLE = {
    ...
    ("frame_inflection", "frame_transition"): "Transition",
    ...
    # Growth rates
    "exp_growth_coeff_BC": "Exponential growth coeff. B to C",
    ...
    'neighbor_avg_lrm_xy_aspect_90um_at_B': "Neighborhood avg. starting XY aspect ratio",
    'neighbor_avg_lrm_mesh_sa_90um_at_B': "Neighborhood avg. starting surface area",
    "mean_neighbor_avg_dxdt_48_volume_90um": "Neighborhood avg. mean transient growth rate",
    'mean_neighbor_avg_lrm_volume_90um': "Neighborhood avg. mean volume", 
    'mean_neighbor_avg_lrm_height_90um': "Neighborhood avg. mean height",
    'mean_neighbor_avg_lrm_density_90um': "Neighborhood avg. mean density",
    'mean_neighbor_avg_lrm_xy_aspect_90um': "Neighborhood avg. mean XY aspect ratio",
    'mean_neighbor_avg_lrm_mesh_sa_90um': "Neighborhood avg. mean surface area",
